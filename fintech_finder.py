...
# To confirm that you have successfully created the transaction, you will save
# screenshots to the README.md file of your GitHub repository for this
...
# Database of Fintech Finder candidates including their name, digital address,
...
# @TODO
# Calculate total `wage` for the candidate by multiplying the candidate’s
# hourly rate from the candidate database (`candidate_database[person][3]`)
#  by the value of the `hours` variable
# YOUR CODE HERE
...
# print(account, candidate_address, wage)
